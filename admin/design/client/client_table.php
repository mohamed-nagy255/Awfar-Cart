<a type="button" class="btn btn-info" href="?action=add" >اضافة عميل</a>
<br />
<br />
<div class="card mb-4">
...
?>
                                        <tr>
                                            ...
                                            $select_pricing = "SELECT prname FROM pricing WHERE id = $namesa";
                                            $query = $conn -> query($select_pricing) -> fetch_assoc();
                                            echo @$query['prname'];
                                            ...
                                            <td><?php
                                                ...
                                                $name = $client['employee_id'];
                                                $select_employee = "SELECT username FROM employee WHERE id = $name";
                                                $query = $conn -> query($select_employee) -> fetch_assoc();
                                                echo @$query['username'];
...
?>
                                            <td>
                                                <a type="button" class="btn btn-info" href="?action=show&id=<?php echo $client['id']?>" >الاستخدامات</a>
                                                <br />
                                                <br />
